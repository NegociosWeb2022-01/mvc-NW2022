...
<section>
  <form action="index.php?page=mnt_rol" method="post">
    ...
    <fieldset>
      ...
      <input {{if readonly}}readonly{{endif readonly}} type="text" id="rolescod" name="rolescod" placeholder="Codigo" value="{{rolescod}}" />
      {{if error_rolescod}}
     ...
     <fieldset>
      ...
      <input {{if readonly}}readonly{{endif readonly}} type="text" id="rolesdsc" name="rolesdsc" placeholder="Descripcion" value="{{rolesdsc}}" />
      {{if error_rolesdsc}}
